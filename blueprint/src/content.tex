...
\begin{lemma}[Minimum degree three]
  ...
  \lean{Erdos1007.unitDistance_of_nine_edges_degree_le_two}
  \leanok
  ...
  The declaration named above is that representability for degree one or two. The dimension
  contradiction is not yet a Lean theorem.
\end{lemma}
...
\begin{lemma}[Five vertices is impossible]
  ...
  \lean{Erdos1007.nine_edges_degree_ge_three_iso_deleteEdge}
  \leanok
  ...
  uniqueness is stated without argument and must be proved here. The isomorphism is the
  declaration named above. The contradiction with $\dim(G) = 4$ is not yet a Lean theorem.
\end{lemma}
...
\begin{lemma}[Six vertices forces $K_{3,3}$]
  ...
  \lean{Erdos1007.nine_edges_six_minDegree_three}
  \leanok
