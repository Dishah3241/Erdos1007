...
\chapter{Unit-distance graphs of dimension four with nine edges}

\begin{definition}[Pairwise coprimality]
  \label{def:pairwise-coprime}
  \lean{Erdos1007.Standalone.Mathlib.PairwiseCoprime}
  \leanok
...
\begin{lemma}[Small primes are pairwise coprime]
  ...
  \lean{Erdos1007.Standalone.Mathlib.SmallPrimesCoprime}
  \leanok
