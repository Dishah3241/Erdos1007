...
Reader-facing modules in `Erdos1007.Standalone.Mathlib` state results so that a reader can
...
private def standaloneMathlibDir : System.FilePath := "Erdos1007" / "Standalone" / "Mathlib"
...
private def forbiddenRoots : Array Name := #[`Erdos1007, `scripts]
